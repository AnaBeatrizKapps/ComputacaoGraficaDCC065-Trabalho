...
export function criaCarro(group, wheels)
{
    ...
    var adesivo = textureLoader.load('../works/Texturas/car/redbull.jpg');
    var adesivo2 = textureLoader.load('../works/Texturas/car/capo_carro.jpg');
    var adesivo3 = textureLoader.load('../works/Texturas/car/placa_carro.jpg');
    ...
    // B. Door Handles
    var car02  = new THREE.TextureLoader().load('../works/Texturas/car/macaneta.jpg');
    ...
    group.translateX(2.0);
    group.translateZ(2.72);
    group.translateY(-22);
