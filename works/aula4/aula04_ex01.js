...
var cylinderMaterial3 = new THREE.MeshPhongMaterial({ color: 'rgb(255,215,0)' });
...
function rotateCylinder() {
    ...
    if (animationOn) {
        ...
        cylinder2.matrix.multiply(mat4.makeTranslation(0.0, 1.07, 0.0)); // T1
        ...
        cylinder3.matrix.multiply(mat4.makeTranslation(0.0, 0.57, 0.0)); // T1
        cylinder3.matrix.multiply(mat4.makeRotationZ(degreesToRadians(90))); // R2

        // Will execute R2, T1 and R1 in this order
        cylinder4.matrix.multiply(mat4.makeRotationY(angle2 * -3)); // R1
        cylinder4.matrix.multiply(mat4.makeTranslation(0.0, -0.57, 0.0)); // T1
        cylinder4.matrix.multiply(mat4.makeRotationZ(degreesToRadians(90))); // R2
    }
}
...
function buildInterface() {
    ...
    gui.add(controls, 'speed', 0.0001, 0.5)
